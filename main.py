...
<body>
    ...
    <!-- كود TradingView المطور والمستقر -->
    ...
    <script type="text/javascript">
        ...
        function initChart(sym) {
            ...
            if (typeof TradingView !== 'undefined') {
                ...
                container.innerHTML = '<div style="display:flex;align-items:center;justify-content:center;height:100%;color:#ff3864;font-size:0.9rem;">تعذر تحميل الشارت.. تأكد من اتصال اللابتوب بالإنترنت ومسح مانع الإعلانات (AdBlock).</div>';
            }
        }
        ...
        // تشغيل التهيئة فور اكتمال بنية الصفحة بالكامل
...
if __name__ == "__main__":
    ...
    print("=" * 55)
    # تفعيل إعادة استخدام المنفذ لتفادي أخطاء المنفذ المحجوز (Address already in use)
