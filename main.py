...
function addNewSection() {
    ...
    renderSections(); saveDataToServer();
}
...
function modifyBalance(t) {
    ...
    renderAllData(); saveDataToServer();
}
...
function updateProfit(){if(!botData)return alert("حمّل الملف");botData.profit_percentage=parseFloat(document.getElementById('profitPercentageInput').value)||0;saveDataToServer()}
function updateGeneralSettings(){if(!botData)return alert("حمّل");botData.required_channel=document.getElementById('botChannelInput').value.trim();botData.bot_news_link=document.getElementById('botNewsInput').value.trim();botData.bot_support_link=document.getElementById('botSupportInput').value.trim();saveDataToServer()}
function updateWelcomeText(){if(!botData)return alert("حمّل");botData.welcome_text=document.getElementById('welcomeTextInput').value;saveDataToServer()}
